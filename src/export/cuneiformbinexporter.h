...
#ifndef CUNEIFORMBINEXPORTER_H
#define CUNEIFORMBINEXPORTER_H
...
class CLA_EXPO CuneiformBinExporter : public Exporter
{
public:
    CuneiformBinExporter(CEDPagePtr page, const FormatOptions& opts);
private:
