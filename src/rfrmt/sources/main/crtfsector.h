...
public:
    ...
    std::vector<unsigned short> m_arHTerminalColumnsIndex;
    std::vector<unsigned short> m_arRightBoundTerminalColumns;
    std::vector<unsigned short> m_arWidthTerminalColumns;
