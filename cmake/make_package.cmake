...
elseif(UNIX AND NOT APPLE)
    ...
    if(CF_USE_ZIP)
        set(CF_DEB_DEPENDS "${CF_DEB_DEPENDS}, libzip1 (>= 0.9)")
    endif()
    if(CF_SERIALIZE)
        set(CF_DEB_DEPENDS "${CF_DEB_DEPENDS}, libboost-serialization1.40.0 (>= 1.40.0-1)")
    endif()
    if(CF_USE_IMAGE_LIBRARY_IMAGE_MAGICK)
        set(CF_DEB_DEPENDS "${CF_DEB_DEPENDS}, libmagick++2 (>= 7:6.5.7.8)")
    endif()
