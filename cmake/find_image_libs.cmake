...
if(CF_USE_IMAGE_LIBRARY_GRAPHICS_MAGICK AND NOT CF_USE_IMAGE_LIBRARY_IMAGE_MAGICK)
    ...
    if(PKG_CONFIG_FOUND)
        ...
        if(GM_FOUND)
            message(STATUS "Image library: GraphicsMagick++ found at ${GM_LIBRARY_DIRS}")
            link_directories(${GM_GraphicsMagick++_LIBDIR})
            list(APPEND CF_IMAGE_INCLUDE ${GraphicsMagick_INCLUDE_DIRS})
            list(APPEND CF_IMAGE_LIBRARIES ${GraphicsMagick_LIBRARIES})
        else()
