...
// CT: ондйкчвемхе ъдпю х нпцюмхгюжхъ опнжеяяю пюяонгмюбюмхъ
#include"tiger.h"
#include "events.h"
...
void CSampleDlg::OnButton1()
{
    ...
    {
        // CT: дЕКЮЕЛ МЕНАУНДХЛШЕ ДЕИЯРБХЪ ДКЪ ОНКСВЕМХЪ ЯНАШРХИ.
...
uint32_t wdCookie;
        ...
        Puma.Load();
        Puma.SetLanguage(7);        // CT: псяяйн-юмцкхияйхи ъгшй
        Puma.SetSpeller(m_spell);   // CT: бйк/бшйк якнбюпмнцн днпюяонгмюбюмхъ
        Puma.RecogClipboard();      // CT: пюяонгмюрэ напюг хг Clipboard
        Puma.Unload();
    }
}
